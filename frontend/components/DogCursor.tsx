...
export default function DogCursor() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      const idle = performance.now() - lastMove > 500;
      ...
      if (dogEl) {
        ...
        if (inner) inner.style.transform = `translate(-50%, -62%) scale(1.4) scaleX(${facing})`;
      }
      if (boneEl) {
        boneEl.style.transform = `translate3d(${mouse.x}px, ${mouse.y}px, 0) translate(-50%, -50%) scale(1.4)`;
          ...
          <div className="dog-sprite" data-show={!sitting}>
            <svg viewBox="0 0 64 48" className="dog-body">
              <g fill="#1D4E7E">
                ...
                <path d="M50,14 C57,13.5 60,16 60,18.5 C60,21 57,22 50,21 Z" />
                <circle cx="59" cy="18.5" r="2.3" />
          ...
          <div className="dog-sprite" data-show={sitting}>
            <svg viewBox="0 0 60 60">
              <g fill="#1D4E7E">
                ...
                <path d="M41,12 C48,11.5 53,14.5 53,18 C53,21 48,21.5 41,20.5 Z" />
              ...
              <g transform="translate(53,20) rotate(18)">
                <path
