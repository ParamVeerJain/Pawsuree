...
export function PointyEar(props: IconProps) {
  return (
    <svg viewBox="0 0 40 54" aria-hidden="true" {...props}>
      <path
        d="M7,49 L17,6 C18,1.5 22,1.5 23,6 L33,49 C27,44.5 13,44.5 7,49 Z"
        fill="#4A87C8"
        stroke="#1D4E7E"
        strokeWidth="3"
        strokeLinejoin="round"
        strokeLinecap="round"
      />
      <path d="M15,43 L19.5,14 C19.8,11.5 20.2,11.5 20.5,14 L25,43 C21,40 19,40 15,43 Z" fill="#D9F1FB" />
    </svg>
  );
}
