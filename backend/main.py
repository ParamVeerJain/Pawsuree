...
NOTIFY_EMAIL = os.environ.get("NOTIFY_EMAIL", "Pawsure@gmail.com")
...
class ApplicationIn(BaseModel):
    ...
    experience: Literal[EXPERIENCE_OPTIONS]
    availability: List[Literal[AVAILABILITY_OPTIONS]] = Field(..., min_length=1)
    motivation: Optional[str] = Field(None, max_length=2000)
    id_proof: Literal[ID_OPTIONS]
    consent: bool
